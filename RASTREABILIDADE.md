...
| H09 | Informações relacionadas a regras, procedimentos, requisitos ou prazos podem exigir interpretação por parte do estudante | H | Consultas desse tipo podem exigir respostas mais organizadas e cuidadosas do que dúvidas puramente informacionais | Investigação futura com estudantes da FEI e, quando pertinente, setores responsáveis | PENDENTE | aberta | Pode influenciar a estruturação das respostas procedimentais e a apresentação de regras, etapas, requisitos e prazos |
| H10 | Uma interpretação equivocada de uma orientação acadêmica ou administrativa pode levar o estudante a executar incorretamente um procedimento, deixar de cumprir uma etapa ou perder um prazo | H | Ajuda a identificar situações em que erros de compreensão podem afetar a execução de uma tarefa acadêmica ou administrativa | Investigação futura com estudantes da FEI e, quando pertinente, setores responsáveis | PENDENTE | aberta | Pode influenciar mecanismos de prevenção de erro, organização das respostas e destaque de informações críticas |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| R01 | Receber uma pergunta em linguagem natural, recuperar informações institucionais relevantes e gerar uma resposta fundamentada | H04, H05 e H08 — necessidade de localizar e compreender informações e possível esforço causado pela distribuição das informações entre diferentes fontes | P01 — Lucas Almeida | C01 — Localização e compreensão de uma informação acadêmica | T01 — Formular uma dúvida em linguagem natural; T02 — Ler e compreender a resposta | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Respostas diretas e compreensíveis para consultas informacionais; evitar exigir que o usuário saiba previamente onde a informação está localizada |
| R02 | Preservar os metadados dos documentos e disponibilizar a origem das informações utilizadas na resposta | H14 — a clareza sobre a origem institucional das informações pode influenciar a confiabilidade percebida | P01 — Lucas Almeida; P02 — Mariana Costa | C01; C02 | T03 — Identificar e consultar a fonte institucional associada à resposta | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Apresentar de forma clara e acessível a fonte institucional relacionada à resposta |
| R03 | Reconhecer quando não existe evidência documental suficiente e evitar gerar respostas sem fundamento institucional | H06, H09, H10 e H16 — consultas procedimentais podem exigir interpretação e erros podem produzir consequências relevantes | P02 — Mariana Costa | C02 — Compreensão do processo de ingresso em um programa de mestrado | T05 — Compreender quando o assistente não possui evidência suficiente e identificar como prosseguir | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Informar explicitamente a ausência de evidência e evitar apresentar como confirmadas regras, etapas, requisitos ou prazos não sustentados pelas fontes |
| R04 | Manter o histórico das interações durante a sessão | H15 — histórico de conversas pode ser útil para retomar informações ou consultas anteriores | P01 — Lucas Almeida; P02 — Mariana Costa | PENDENTE | T06 — Consultar perguntas e respostas anteriores | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Funcionalidade permanece como hipótese e deverá ser validada antes de ser tratada como necessidade obrigatória |
| R05 | Manter uma interação conversacional que permita continuidade da consulta | H04 e H18 — o estudante pode precisar complementar uma dúvida e o padrão conversacional pode ser familiar ao público | P01 — Lucas Almeida; P02 — Mariana Costa | PENDENTE | T04 — Fazer uma nova pergunta ou complementar uma pergunta anterior | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Permitir perguntas complementares e continuidade da consulta sem exigir que o estudante reinicie sua busca |

> As personas P01 e P02 foram definidas na Entrega 3 como proto-personas e ainda precisam ser validadas com estudantes reais da FEI. Sua criação não confirma as hipóteses às quais estão relacionadas.

> Os cenários de análise/problema C01 e C02 foram definidos na Entrega 4 e relacionados às necessidades correspondentes nesta matriz. Os campos referentes a modelos de tarefas, cenários de interação/signos, MoLIC, Figma, avaliação heurística e testes permanecem como `PENDENTE` até que esses artefatos sejam produzidos nas próximas entregas.
---
...
|---|---|---|---|---|---|
| PENDENTE | Interface conversacional | T01, T02 e T04 | Formular uma pergunta em linguagem natural, visualizar e compreender a resposta e continuar a interação quando necessário | Interface prevista no TCC; H04 e H18 | P01, P02, R01, R05 |
| PENDENTE | Apresentação de fontes/evidências | T03 | Identificar a origem institucional da informação utilizada para fundamentar a resposta | Preservação das fontes prevista no TCC; H14 | P01, P02, R02 |
| PENDENTE | Tratamento de ausência de evidência e mensagens de limitação | T05 | Informar de forma clara quando o assistente não possui informação suficiente para responder e orientar o estudante sobre como prosseguir | Tratamento de ausência de evidência previsto no TCC; H06 e H16 | P02, R03 |
| PENDENTE | Histórico de conversa | T06 | Consultar perguntas e respostas realizadas anteriormente durante a interação | H15 | P01, P02, R04 |
