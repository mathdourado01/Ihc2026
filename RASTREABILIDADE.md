...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| R01 | Receber uma pergunta em linguagem natural, recuperar informações institucionais relevantes e gerar uma resposta fundamentada | H04, H05 e H08 — necessidade de localizar e compreender informações e possível esforço causado pela distribuição das informações entre diferentes fontes | P01 — Lucas Almeida | PENDENTE | T01 — Formular uma dúvida em linguagem natural; T02 — Ler e compreender a resposta | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Respostas diretas e compreensíveis para consultas informacionais; evitar exigir que o usuário saiba previamente onde a informação está localizada |
| R02 | Preservar os metadados dos documentos e disponibilizar a origem das informações utilizadas na resposta | H14 — a clareza sobre a origem institucional das informações pode influenciar a confiabilidade percebida | P01 — Lucas Almeida; P02 — Mariana Costa | PENDENTE | T03 — Identificar e consultar a fonte institucional associada à resposta | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Apresentar de forma clara e acessível a fonte institucional relacionada à resposta |
| R03 | Reconhecer quando não existe evidência documental suficiente e evitar gerar respostas sem fundamento institucional | H06, H09, H10 e H16 — consultas procedimentais podem exigir interpretação e erros podem produzir consequências relevantes | P02 — Mariana Costa | PENDENTE | T05 — Compreender quando o assistente não possui evidência suficiente e identificar como prosseguir | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Informar explicitamente a ausência de evidência e evitar apresentar como confirmadas regras, etapas, requisitos ou prazos não sustentados pelas fontes |
...
> Os campos relacionados a cenário, modelos de tarefas, signos, MoLIC, Figma, avaliação heurística e testes permanecerão como `PENDENTE` até que esses artefatos sejam produzidos nas próximas entregas.
